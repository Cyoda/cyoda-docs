---
title: "Cyoda-Go v0.8.3"
description: "Scheduled state transitions, Cloud-aligned search semantics, and honest attribution for follow-on actions."
sidebar:
  label: "v0.8.3"
...
- **Scheduled state transitions:** A transition can carry `schedule: {delayMs, timeoutMs}` and fire automatically, durably armed and cancelled with the
...
[CHANGELOG](https://github.com/Cyoda/cyoda-go/blob/main/CHANGELOG.md#083--2026-07-27).
...
v0.8.3 is a patch release that carries breaking changes — listed in the
