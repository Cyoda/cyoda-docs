...
`type` discriminator, and there are four of them. The same DSL is used by
workflow and transition criteria, so what you learn here transfers directly.
